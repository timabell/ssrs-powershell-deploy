if (-not (Test-Path("cred2.txt"))) {
	...
	Write-Host "» To publish the Debug configuration to localhost, type"
...
Publish-SSRSProject -Path 'pathtoproject\ProjectFile.rptproj' -Configuration 'Debug' -Credential $cred
